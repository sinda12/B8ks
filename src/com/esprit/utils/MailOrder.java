...
public class MailOrder { 
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recepient,String x) {
        try {
            ...
            //code=randomcode();
            String htmlCode = "<h1>Order </h1> <br/> <h2><b>Your Order is being processed on : "+dateFormat.format(date)+"<br/><br/>"+x+"</b></h2>";
            message.setContent(htmlCode, "text/html");
            return message;
        } catch (Exception ex) {
            Logger.getLogger(MailOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
}
