...
public class UsedBooksViewController extends BaseController implements Initializable{
	...
	private ObservableList <usedbook> usedbookData = FXCollections.observableArrayList();
	@FXML
	...
	public void ajouter(ActionEvent event) {
		if (lstitre.getText().trim().length() > 0 && lsprix.getText().trim().length()> 0
			...
			aj2.ajouter(new Entity.usedbook(lstitre.getText(),Double.valueOf(lsprix.getText()),lsauteur.getText(),lsdesc.getText(),lsdate.getText()));
			usedbookData.clear();
